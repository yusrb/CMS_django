...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-end me-4 rotate-caret" id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="/">
      ...
      <span class="me-1 font-weight-bold">Aspire CMS</span>
    </a>
  </div>
  ...
  <div class="sidenav-footer mx-3 ">
    ...
    <a href="https://appseed.us/product/argon-dashboard/django/" target="_blank" class="btn btn-dark btn-sm w-100 mb-3">Download</a>
